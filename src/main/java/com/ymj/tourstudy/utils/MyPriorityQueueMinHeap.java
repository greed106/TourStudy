...
public class MyPriorityQueueMinHeap<T> {
     ...
     */
    public MyPriorityQueueMinHeap(Comparator<T> comparator) {
    ...
    public static void main(String[] args) {
        // 使用Lambda表达式定义比较器，例如，此处定义一个Integer的升序比较器
        MyPriorityQueueMinHeap<Integer> priorityQueue = new MyPriorityQueueMinHeap<>((a, b) -> a - b);
        priorityQueue.insert(10);
        priorityQueue.insert(5);
        priorityQueue.insert(20);
        priorityQueue.insert(1);

        System.out.println("最小元素: " + priorityQueue.remove());
        System.out.println("下一个最小元素: " + priorityQueue.peek());
